...
<h2>Follow each link to the page example</h2>
    <ul class="nav">
        ...
        <li class="nav-item"><a class="nav-link" href="whiledowhileloop.php">Do While</a></li>
        ...
        <li class="nav-item"><a class="nav-link" href="datetimemanip.php">String Manipulation<a></li>
        <li class="nav-item"><a class="nav-link" href="functions.php">Function<a></li>
    </ul>